      ...
      <div className="about-container">
        ...
        <div className="main-content">
          <h2 className="hero-title">
            Faux Finds – Got questions? We've got answers!
          </h2>
          ...
          <div className="content-row">
            ...
            <div className="card">
              ...
              <div className="card-body">
                <p>
                  We started Faux Finds with a simple idea: to make it easy for
                  everyone to find stylish, trendy, and practical products at
                  fair prices. Fashion, jewelry, tech, accessories – we love
                  everything that makes everyday life a little more fun and
                  easier! Our goal? A shopping experience that's simple,
                  inspiring, and full of amazing finds.
                  <br />
                  <br />
                  <br />
          ...
          <div className="content-row">
            <div className="card">
              ...
              <div className="card-body">
                <p>
                  <strong>Adress:</strong> Tomtebodavägen 3A
                </p>
                <p>
                  <strong>Email:</strong> FauxFinds@live.com
                </p>
                <p>
                  We do not accept return requests etc. via email, only through
                  the contact form.
                </p>
              </div>
            </div>
